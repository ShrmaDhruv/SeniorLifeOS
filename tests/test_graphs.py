...
from seniorlife_os import benefits_graph, build_benefits_graph, build_document_graph, document_graph
...
class DocumentGraphTests(unittest.TestCase):
    def test_corrected_income_certificate_is_confirmed_with_provenance(self):
        result = document_graph.invoke(document_success_state())
    ...
    def test_blurry_page_requests_reupload(self):
        result = document_graph.invoke(document_failure_state())
...
class BenefitsGraphTests(unittest.TestCase):
    def test_confirmed_document_flows_into_approved_package(self):
        document = document_graph.invoke(document_success_state())["vault_record"]
        result = benefits_graph.invoke(benefits_success_state(document))
    ...
    def test_missing_income_is_unknown_and_blocks_package(self):
        result = benefits_graph.invoke(benefits_failure_state())
    ...
    def test_conflicting_confirmed_income_blocks_package(self):
        ...
        result = benefits_graph.invoke(state)
